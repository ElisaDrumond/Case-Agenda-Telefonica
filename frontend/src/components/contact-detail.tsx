    ...
    return (
        <SheetContent>
            ...
            <div className="grid gap-4 py-4">
                ...
                <InputPersonalInformation id="name" title="Name" placeholder="John Doe" typeInput="string"/>
                <InputPersonalInformation id="email" title="Email" placeholder="john.doe@email.com" typeInput="email"/>
                <InputPersonalInformation id="number" title="Number" placeholder="999-9999-999" typeInput="string"/>
                <InputPersonalInformation id="dateBirth" title="Date of Birth" placeholder="" typeInput="date"/>
            </div>
